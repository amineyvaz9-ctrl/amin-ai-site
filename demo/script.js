...
// маленький канвас под вход 224x224 для модели
const inputCanvas = document.createElement('canvas');
inputCanvas.width = 224; inputCanvas.height = 224;
const ictx = inputCanvas.getContext('2d');

// строка результата (метка + шкала + процент)
...
async function loadModel() {
  ...
  // рисуем строки сразу, чтобы были видны названия классов
  labelContainer.innerHTML = '';
  ...
  // спрячем подсказку "Положите файлы..." если есть
